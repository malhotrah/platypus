 ...
 * @return string
 */
function whisper_template_path()
{
	return Whisper_Theme_Wrapper::$main_template;
}
 ...
 * @return string
 */
function whisper_template_base()
{
	return Whisper_Theme_Wrapper::$base;
}

/**
 * Theme wrapper class
 */
class Whisper_Theme_Wrapper
{
	/**
...
add_filter( 'template_include', array( 'Whisper_Theme_Wrapper', 'wrap' ), 99 );
