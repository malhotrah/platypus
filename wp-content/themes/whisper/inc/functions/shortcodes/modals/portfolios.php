<div class="fitsc-config">
	...
	<div class="fitsc-field">
		<label class="fitsc-label"><?php _e( 'Number Of Portfolios', 'whisper' ); ?></label>
	...
	<div ng-show="advanced">
		...
		<div class="fitsc-field">
			<label class="fitsc-label"><?php _e( 'Show Format Icon', 'whisper' ); ?></label>

			<div class="fitsc-controls">
				<input ng-model="format_icon" type="checkbox" ng-true-value="1" ng-false-value="" ng-init="format_icon = '1'">
			</div>
		</div>
		<div class="fitsc-field">
...
<div class="fitsc-preview">
	<div class="fitsc-preview-shortcode">
		...
		<pre class="fitsc-preview-content fitsc-shortcode"><?php
			$text = "[$shortcode";
			$text .= FITSC_Helper::shortcode_atts( 'title_wrap', 'title', 'number', 'format_icon', 'total_columns' );
			$text .= ']';
			echo $text;
			?></pre>
	</div>
